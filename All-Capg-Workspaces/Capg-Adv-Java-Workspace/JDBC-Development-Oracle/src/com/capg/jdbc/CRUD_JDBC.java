        ...
        try {
	        ...
	        try {
		        ...
		        while(flag){
		            ...
		            System.out.println("3. Read Rows");
		            ...
		            switch (choice) {
		                ...
		                case 1:
		                    String insertSql =
		                        "INSERT INTO EmployeesInfo1 VALUES (?, ?, ?)";
		                ...
		                case 2:
		                    String updateSql =
		                        "UPDATE Employeesinfo1 SET SAL = ? WHERE EMPNO = ?";
		                ...
		                case 3:
		                    String selectSql = "SELECT * FROM Employeesinfo1";
		                ...
		                case 4:
		                    String deleteSql =
		                        "DELETE FROM Employeesinfos1 WHERE EMPNO = ?";
